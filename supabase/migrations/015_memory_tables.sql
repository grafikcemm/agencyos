-- Migration 015 — Memory/strateji tabloları.
-- Önceden src/lib/migrations/001_memory_tables.sql altında, normal Supabase migration
-- akışından kopuktu. Repo'dan şemanın tekrar-üretilebilir olması için buraya taşındı.
-- Kullanım: memory/route.ts, memory/learn/route.ts, council/route.ts.
...
-- Seed initial strategy fields (idempotent).

  ...
  return (
    <div className="bg-[#111111] border border-[#1f1f1f] rounded-xl overflow-hidden mb-6">
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-5 py-4 text-left hover:bg-[#161618] transition-colors"
      >
      ...
      {isOpen && (
        <div className="border-t border-[#1a1a1a] bg-[#0d0d0e]/30 px-5 py-5">
          {/* Internal Tabs */}
          <div className="flex gap-2 border-b border-[#1a1a1a] pb-3 mb-4 overflow-x-auto">
            <button
              ...
              className={cn(
                ...
                activeTab === "roadmap"
                  ...
                  : "bg-transparent border-transparent text-[#555555] hover:text-[#ababab]"
              )}
            >
              <Layers size={12} />
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4">
                {weeks.map((w) => (
                  <div
                    key={w.week}
                    className="border border-[#1a1a1a] rounded-xl p-4 bg-[#111111]"
                  >
                    ...
                    <div className="space-y-2.5 mt-3 text-[11px] leading-relaxed">
                      <div>
                        <span className="text-[#555555] font-mono uppercase font-bold text-[9px] tracking-wider block">HEDEF</span>
                        <span className="text-[#ababab]">{w.goal}</span>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                        <div>
                          <span className="text-[#555555] font-mono uppercase font-bold text-[9px] tracking-wider block">HAFTALIK ÇIKTI</span>
                          <span className="text-white font-medium">{w.output}</span>
                        </div>
                        <div>
                          <span className="text-[#555555] font-mono uppercase font-bold text-[9px] tracking-wider block">REELS (İÇERİK)</span>
                          <span className="text-white font-medium">&quot;{w.reels}&quot;</span>
                        </div>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                          <span className="text-[#555555] font-mono uppercase font-bold text-[9px] tracking-wider block">CAROUSEL DÖNÜŞÜM</span>
                          <span className="text-white font-medium">&quot;{w.carousel}&quot;</span>
                        </div>
                        <div>
                          <span className="text-[#555555] font-mono uppercase font-bold text-[9px] tracking-wider block">DAĞITIM KANALLARI</span>
          ...
          {activeTab === "pdf_skeleton" && (
            <div className="space-y-4 text-xs">
              <div className="border border-[#1a1a1a] rounded-xl p-4 bg-[#111111] leading-relaxed space-y-4">
                <div className="flex items-center gap-2 border-b border-[#1a1a1a] pb-2">
                  <BookOpen size={14} className="text-[var(--accent)]" />
                  <h4 className="font-mono font-bold text-white text-[11px] tracking-wider">
          ...
          {activeTab === "reels_template" && (
            <div className="space-y-4 text-xs">
              <div className="border border-[#1a1a1a] rounded-xl p-4 bg-[#111111] leading-relaxed space-y-4">
                ...
                <div className="space-y-3.5 text-[11px]">
                  <div>
                    <span className="text-[#EF4444] font-mono font-bold block mb-1">🔥 HOOK (İlk 3 Saniye)</span>
                  ...
                  <div>
                    <span className="text-[#6366f1] font-mono font-bold block mb-1">💡 DEĞER SUNUMU & GÖVDE</span>
                    <p className="text-[#888888]">
                  ...
                  <div>
                    <span className="text-[#22C55E] font-mono font-bold block mb-1">🎯 CTA (Aksiyon Çağrısı)</span>
                    <p className="text-[#888888] italic">

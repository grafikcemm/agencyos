        ...
        <div className="flex justify-between items-center flex-wrap gap-3">
          <div>
            <h1 className="font-display text-2xl font-bold tracking-tight text-[var(--text-primary)] flex items-center gap-2">
              <Target className="w-5 h-5" /> Bugünün Fırsatları
            </h1>
            <p className="text-xs text-[var(--text-muted)] mt-0.5">
              Kanıta dayalı, konseyden geçmiş karar-hazır fırsatlar · günde en fazla 2, zayıf aday kota doldurmaz
            </p>
          </div>
          <button
            onClick={fetchOpportunities}
            className="flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-bold rounded-full bg-[var(--bg-elevated)] text-[var(--text-primary)] hover:bg-[var(--bg-surface)] transition-colors"
          >
